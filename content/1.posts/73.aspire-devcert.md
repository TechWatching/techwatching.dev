---
title: "Aspirations - Use ASP.NET Core HTTPS Development Certificate"
...
And that's it. Thanks to Aspire, setting up HTTPS in our application is now easier. And from what I've read about the issues on the repository, it seems there are likely improvements coming to Aspire to make this feature built-in and even better. Anyway, this is a great example of how we can easily customize Aspire to fit our needs and enhance the developer experience.
