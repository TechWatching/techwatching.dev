...
![OpenTelemetry environment variables in the .NET Aspire dashboard.](/posts/images/71.aspire-otel_1.png){.rounded-lg.mx-auto  }
...
![Logs of the WebApi in the .NET Aspire dashboard.](/posts/images/71.aspire-otel_2.png){.rounded-lg.mx-auto }

![Traces of the WebApi in the .NET Aspire dashboard.](/posts/images/71.aspire-otel_3.png){.rounded-lg.mx-auto }

![Metrics of the WebApi in the .NET Aspire dashboard.](/posts/images/71.aspire-otel_4.png){.rounded-lg.mx-auto }
...
![HTTP OTEL endpoint environment variable in the .NET Aspire dashboard.](/posts/images/71.aspire-otel_5.png){.rounded-lg.mx-auto }
...
![Environment variables twice in .NET Aspire dashboard.](/posts/images/71.aspire-otel_6.png){.rounded-lg.mx-auto }
