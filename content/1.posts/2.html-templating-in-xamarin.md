...
![Add new item in Xamarin Project in Visual Studio](/posts/images/htmltemplating_vs_1.png){ .rounded-lg .mx-auto width="300" }
...
![File properties of a cshtml file in Visual Studio](/posts/images/htmltemplating_vs_2.png){ .rounded-lg .mx-auto width="400" }
