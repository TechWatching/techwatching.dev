...
![Diagram of how Pulumi works.](/posts/images/pulumiazurebackend_schema_1.png){.rounded-lg .mx-auto}
...
![Azure CLI script in vscode.](/posts/images/pulumiazurebackend_vscode_1.png){.rounded-lg .mx-auto}
