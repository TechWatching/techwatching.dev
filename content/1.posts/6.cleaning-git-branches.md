...
![List all git branches in the terminal.](/posts/images/cleaningbranches_shell_1.png){.rounded-lg .mx-auto }
...
![List all git branches with verbose tag in terminal.](/posts/images/cleaningbranches_shell_2.png){.rounded-lg .mx-auto }
...
![List git branches in table in the terminal.](/posts/images/cleaningbranches_shell_3.png){.rounded-lg .mx-auto }
...
![List git branches in table with columns by property in the terminal.](/posts/images/cleaningbranches_shell_4.png){.rounded-lg .mx-auto }

We then just have to filter the table to get only the lines with the Status `[gone]`.

![Filter on git branches gone in the terminal.](/posts/images/cleaningbranches_shell_5.png){.rounded-lg .mx-auto }
...
![List oudated git branches  in the terminal.](/posts/images/cleaningbranches_shell_6.png){.rounded-lg .mx-auto }
