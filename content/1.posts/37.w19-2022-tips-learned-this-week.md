...
![GitLens Command Palette in vscode](/posts/images/w192022tips_gitlens_1.png){.rounded-lg .mx-auto }
...
![Doing a Git fetch in GitLens Command Palette.](/posts/images/w192022tips_gitlens_2.png){.rounded-lg .mx-auto }
...
![Vue Telescope extension showing Vue Telescope stack on its website.](/posts/images/w192022tips_vuetelescope_1.png){.rounded-lg .mx-auto }
...
![Vue Telescope search.](/posts/images/w192022tips_vuetelescope_2.png){.rounded-lg .mx-auto }
...
![Website of Add New File Visual Studio extension.](/posts/images/w192022tips_addnewfile_1.png){.rounded-lg .mx-auto }

As you can see you can even create the missing folders where the file is placed.

![Usage of Add New File in Visual Studio.](/posts/images/w192022tips_addnewfile.gif){.rounded-lg .mx-auto }
