...
![Azure portal home](/posts/images/azurecli_portal_1.png){ .rounded-lg .mx-auto width="800"}
...
![Azure CLI Tools vscode extension.](/posts/images/azurecli_vscode_1.png){ .rounded-lg .mx-auto width="800"}
...
![Azure cloud shell in browser.](/posts/images/azurecli_cloudshell_1.png){ .rounded-lg .mx-auto width=1000}
...
![Scoped commands in Azure CLI interactive mode.](/posts/images/azurecli_interactive_2.png){ .rounded-lg .mx-auto width=1000}
...
![JMESPath examples to filter Azure CLI interactive output.](/posts/images/azurecli_interactive_3.png){ .rounded-lg .mx-auto width=1000}
